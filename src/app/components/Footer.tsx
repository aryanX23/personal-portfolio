...
const Footer: React.FC = () => {
  ...
  return (
    <motion.footer
      className="bg-white/80 dark:bg-black/30 backdrop-blur-lg text-gray-700 dark:text-gray-400 py-8 px-4 md:px-8 border-t border-black/10 dark:border-white/10"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        <div className="flex space-x-5">
          {socialLinks.map((link) => (
            <motion.a
              ...
              className="text-gray-600 dark:text-gray-300 hover:text-gradient-via transition-colors duration-200"
